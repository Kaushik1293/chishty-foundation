                    ...
                    <div className="flex items-center justify-between h-20 lg:h-24 md:px-6">
                        ...
                        <Link href="/" className="shrink-0">
                            <motion.img
                                ...
                                src={isScrolled ? whiteLogo.src : logo.src}
                                alt="logo"
                                ...
                                >
                                    <a
                                     ...
                                     ${activeSection === item.id
                                                ? `${isScrolled ? "text-white" : "text-dark-green"} font-bold`
                        ...
                        <div className="hidden 2xl:flex items-center gap-4">
                            <PrimaryButton text={"Donate Now"} containerClassName={`${isScrolled ? "bg-dark-yellow" : "bg-dark-green"}`} iconWrapperClassName={`${isScrolled ? "!bg-dark-green" : "!bg-dark-yellow"}`}
