...
import { Plus, Search, Filter, RefreshCw, Image as ImageIcon } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-dark-green/75 font-normal mt-0.5">
            Upload, organize, caption, and manage photos and media assets across Chishty Foundation.
          </p>
        </div>
      ...
      <div className="p-4 rounded-2xl bg-white border border-stroke shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full sm:w-80">
          ...
          <input
            ...
            placeholder="Search by title, caption, alt text..."
