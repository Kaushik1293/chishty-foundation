    ...
    <header className="sticky top-0 z-30 bg-beige/90 backdrop-blur-md border-b border-stroke px-4 md:px-8 py-4 transition-all">
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl md:text-2xl font-bold font-cormorant text-dark-green leading-tight">
              {pageInfo.title}
            </h1>
        ...
        <div className="flex items-center gap-2 md:gap-4">
          ...
          <div className="relative">
            <button
              ...
              className="relative p-2.5 rounded-xl bg-dark-green/5 hover:bg-dark-green/10 text-dark-green transition-colors"
              aria-label="Notifications"
            >
              <Bell className="w-4 h-4 md:w-5 md:h-5" />
              <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-dark-yellow rounded-full ring-2 ring-beige" />
            </button>
            ...
            <AnimatePresence>
              {isNotifOpen && (
                <motion.div
                  ...
                  className="absolute right-0 mt-3 w-80 bg-beige border border-stroke shadow-2xl rounded-2xl p-4 z-50 overflow-hidden"
                >
                  <div className="flex items-center justify-between pb-3 border-b border-stroke">
                    <span className="font-cormorant font-bold text-lg text-dark-green">
                      Notifications
                    </span>
                    <span className="text-[10px] px-2 py-0.5 rounded-full bg-dark-yellow/20 text-dark-green font-mono font-semibold">
                      3 New
                    </span>
                  </div>
                  ...
                  <div className="divide-y divide-stroke/60 py-2">
                    {mockNotifications.map((n) => (
                      <div
                        key={n.id}
                        className="py-2.5 px-2 hover:bg-dark-green/5 rounded-xl transition-colors cursor-pointer"
                      >
                        ...
                        <p className="text-xs text-dark-green/70 mt-0.5 line-clamp-1">
                          {n.desc}
                        </p>
                      </div>
                    ))}
                  ...
                  <button className="w-full mt-2 py-2 text-center text-xs font-semibold text-dark-yellow hover:text-dark-green transition-colors border-t border-stroke pt-3">
                    View All Activity
                  </button>
                </motion.div>
              )}
          ...
          <div className="relative">
            ...
            >
              <div className="w-7 h-7 rounded-lg bg-gradient-to-tr from-dark-yellow to-[#FFD56C] text-dark-green font-bold text-xs flex items-center justify-center">
                A
              </div>
