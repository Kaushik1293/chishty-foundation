...
export default function InsightsHeader({
  ...
  return (
    <div className="space-y-8 font-satoshi">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-dark-green/75 font-normal mt-0.5">
            Create, view, update, and manage foundation insights, articles, and publications.
          </p>
        </div>
      ...
      {/* Controls Bar: Search & Status/Category Filters */}
        ...
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
          {categories.length > 0 && (
            <AsgardSelect
              ...
              icon={<BookOpen className="w-3.5 h-3.5 text-dark-yellow" />}
