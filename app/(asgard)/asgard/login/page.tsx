      ...
      >
        ...
        <div className="text-center space-y-3 mb-8">
          <motion.div
            ...
            className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-dark-yellow to-rust-orange p-0.5 shadow-xl border border-white/20 mb-2"
          >
            <motion.img
              src={star.src || star}
          ...
          <p className="text-xs text-white/70 font-satoshi max-w-xs mx-auto">
            Chishty Foundation Admin Portal & Dynamic Content Management
          </p>
        </div>
        ...
        {/* Login Form */}
        <form onSubmit={handleLogin} className="space-y-5 font-satoshi">
          {/* Email Input */}
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/15 focus:border-dark-yellow focus:ring-2 focus:ring-dark-yellow/30 rounded-xl text-white placeholder-white/30 text-sm transition-all outline-none"
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <a
                ...
                onClick={(e) => {
                  e.preventDefault();
                  alert(
                    "Demo Hint: Click 'Fill Demo Credentials' to autofill test credentials!"
                  );
                }}
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••••••"
                className="w-full pl-10 pr-10 py-3 bg-white/5 border border-white/15 focus:border-dark-yellow focus:ring-2 focus:ring-dark-yellow/30 rounded-xl text-white placeholder-white/30 text-sm transition-all outline-none"
              />
              <button
                type="button"
          ...
          <motion.button
            ...
            type="submit"
            disabled={isLoading}
            className="w-full py-3.5 px-4 rounded-xl bg-gradient-to-r from-dark-yellow to-rust-orange text-white font-semibold text-sm shadow-lg shadow-dark-yellow/20 flex items-center justify-center gap-2 transition-all hover:brightness-110 disabled:opacity-50 cursor-pointer"
          >
            {isLoading ? (
              <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin" />
            ) : (
              <>
                <span>Sign In to Asgard</span>
        ...
        <div className="mt-6 pt-6 border-t border-white/10 text-center space-y-3">
          <button
            ...
            className="w-full py-2.5 px-3 rounded-xl bg-white/5 hover:bg-white/10 border border-dark-yellow/30 text-[#FFD56C] text-xs font-semibold flex items-center justify-center gap-2 transition-all cursor-pointer"
          >
          ...
          <p className="text-[11px] text-white/40">
            Protected by Supabase Auth & Role-Based Control
          </p>
        </div>
      </motion.div>
    </div>
